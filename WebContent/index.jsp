	...
	<section class="container">
		<form method="get" action="./index.jsp" class="form-inline mt-3">
			...
			<select name="searchType" class="form-control mx-1 mt-2">
				...
				<option value="추천순" <% if(searchType.equals("최신순")) out.println("selected"); %>>최신순</option>
			</select>
		...
		<div class="card bg-light mt-3">
			<div class="card-header bg-light">
				<div class="row">
					...
					종합<span style="color: red;"><%= evaluation.getTotalScore() %></span></div>
				</div>
			</div>
			<div class="card-body">
				<h5 class="card-title">
				...
				<div class="row">
					<div class="col-9 text-left">
						...
						강의<span style="color: red;"><%= evaluation.getLectureScroe() %></span>
				...
				<div class="modal-body">
					<form action="./evaluationRegisterAction.jsp" method="post">
						...
						<div class="form-row">
							...
							<div class="form-group col-sm-3">
								<label>강의</label>
								<select name="lectureScroe" class="form-control">
									<option value="A" selected>A</option>
									<option value="B">B</option>
									<option value="C">C</option>
									<option value="D">D</option>
